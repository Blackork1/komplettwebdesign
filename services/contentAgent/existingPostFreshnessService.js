...
const SEARCH_CHANGE_MARKER = '(?:änder\\w*|update\\w*|aktualisier\\w*|rollout\\w*|ein(?:ge)?führ\\w*|führ\\w*[^.!?]{0,32}\\bein\\b|neu(?:e|en|er|es)?\\s+(?:anforderung\\w*|richtlinie\\w*|funktion\\w*|feature\\w*|regel\\w*)|aktuell\\w*\\s+(?:anforderung\\w*|richtlinie\\w*|funktion\\w*|feature\\w*|stand\\w*))';
