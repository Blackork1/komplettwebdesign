...
export const packages = Object.freeze([
  makePackage({
    ...
    bestFor: 'Kompakter Einstieg für ein klar begrenztes Angebot',
    nextStepLabel: 'Start-Paket anfragen',
    targetGroup: [
      'Gründer',
      'Selbstständige',
  ...
  makePackage({
    ...
    bestFor: 'Empfohlene Standardwahl für kleine Unternehmen mit mehreren Leistungen',
    nextStepLabel: 'Business-Website planen',
    targetGroup: [
      'kleine Unternehmen',
    ...
    ctaLabel: 'Business-Website planen',
  ...
  makePackage({
    ...
    bestFor: 'Mehr Seiten oder Relaunch mit mehreren Leistungen und Zielgruppen',
    nextStepLabel: 'Wachstumsprojekt besprechen',
    targetGroup: [
    ...
    ctaLabel: 'Wachstumsprojekt besprechen',
  ...
  makePackage({
    ...
    bestFor: 'Sonderfunktionen wie Buchung, Shop, CMS oder Schnittstellen',
    nextStepLabel: 'Individuelle Lösung anfragen',
    targetGroup: [
    ...
    ctaLabel: 'Individuelle Lösung anfragen',
