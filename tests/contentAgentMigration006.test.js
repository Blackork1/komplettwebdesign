...
test('Migrationsrunner führt 006 bis 010 in Reihenfolge aus und meldet den vollständigen Bereich im Abschluss', async () => {
  ...
  assert.match(source, /Migration 002 bis 013 erfolgreich/i);
});
