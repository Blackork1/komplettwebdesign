export const INDEXABLE_STATIC_ROUTES = [
  ...
  { path: '/en/pakete/start', changefreq: 'monthly', priority: 0.7 },
  { path: '/en/pakete/business', changefreq: 'monthly', priority: 0.7 },
  { path: '/en/pakete/wachstum', changefreq: 'monthly', priority: 0.7 },
  { path: '/en/pakete/individuell', changefreq: 'monthly', priority: 0.6 },
