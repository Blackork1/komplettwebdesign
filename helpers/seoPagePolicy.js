export const INDEXABLE_STATIC_ROUTES = [
  ...
  { path: '/pakete/start', changefreq: 'monthly', priority: 0.7 },
  { path: '/pakete/business', changefreq: 'monthly', priority: 0.7 },
  { path: '/pakete/wachstum', changefreq: 'monthly', priority: 0.7 },
  { path: '/pakete/individuell', changefreq: 'monthly', priority: 0.6 },
  ...
  { path: '/swipeandcook-nutzungsbedingungen', changefreq: 'yearly', priority: 0.2 },
  { path: '/swipeandcook-support', changefreq: 'yearly', priority: 0.2 },
  { path: '/swipeandcook-konto-loeschen', changefreq: 'yearly', priority: 0.2 },
  ...
  { path: '/leistungen/landingpage-erstellen-lassen', changefreq: 'monthly', priority: 0.85 },
  ...
  { path: '/leistungen/laufende-kosten-website', changefreq: 'monthly', priority: 0.75 },
  { path: '/leistungen/zusatzleistungen-webdesign', changefreq: 'monthly', priority: 0.75 },
  { path: '/leistungen/website-wartung', changefreq: 'monthly', priority: 0.75 },
  { path: '/leistungen/local-seo', changefreq: 'monthly', priority: 0.78 },
